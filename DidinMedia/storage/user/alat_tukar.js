  const fs = require('fs')
  let _inventoryOrang = JSON.parse(fs.readFileSync('./DidinMedia/storage/user/inventory.json'))
  ...
  const addInventori = (sender) => {
        ...
        fs.writeFileSync('./DidinMedia/storage/user/inventory.json', JSON.stringify(_inventoryOrang))
   }
